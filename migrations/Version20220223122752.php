 ...
 */
final class Version20220223122752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE package ADD is_handed_over TINYINT(1) DEFAULT NULL');
        $this->addSql('ALTER TABLE package_audit ADD is_handed_over TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE package DROP is_handed_over');
        $this->addSql('ALTER TABLE package_audit DROP is_handed_over, CHANGE revtype revtype VARCHAR(4) NOT NULL COLLATE `utf8mb4_unicode_ci`');
